...
<center>
![metadata](../img/metadata_view.png){ width="400"} 
...
```
<center>
![readtable](../img/read.table-help.png){ width="450"} 
...
![img](../img/metadata_display_row_cols.png){width=300}
