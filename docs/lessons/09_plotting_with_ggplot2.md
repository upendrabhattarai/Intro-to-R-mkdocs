...
|Data | Download link |
|:------|:--------|
|Data |[Right click & Save link as...](https://github.com/hbctraining/Intro-to-R-flipped/raw/master/data/new_metadata.RData){ .md-button}|
...
!!!note "Note"
    If you are interested in learning about plotting with base R functions, we have a short [lesson](basic_plots_in_r.md){ .md-button}. 
...
!!!note "Note"
    You can find out more about tibbles in the lesson on [tidyverse](https://hbctraining.github.io/Training-modules/Tidyverse_ggplot2/lessons/intro_tidyverse.html){ .md-button}
...
<center>
![img](../img/ggscatter-1.png){width=500}
</center>
...
<center>
![img](../img/ggscatter-2.png){width=600}
</center>
...
<center>
![img](../img/ggscatter-3.png){width=600}
</center>
...
<center>
![img](../img/ggscatter-4.png){width=600}
</center>
...
<center>
![img](../img/ggscatter-5.png){width="600"}
</center>
